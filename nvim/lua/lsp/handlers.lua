...
M.setup = function()
	local signs = {
		...
		{ name = "DignosticSignHint", text = "" },
		{ name = "DignosticsSignInfo", text = "" },
	}
...
local function lsp_keymaps(bufnr)
	...
	keymap(bufnr, "n", "<S-r>", "<cmd>lua vim.lsp.buf.rename()<CR>", opts)
...
M.on_attach = function(client, bufnr)
	...
	if client.name == "lua_ls" then
		client.server_capabilities.docuemtFormattingProvider = false
	end
